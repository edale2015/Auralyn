...
export const CaseStateSchema = z.object({
  ...
  physicianPacket: z.any().optional(),
  completeness: z.any().optional(),
  testYield: z.any().optional(),
  medicationSafety: z.any().optional(),
  calibration: z.any().optional(),
  feedbackStats: z.any().optional(),
  severity: z.any().optional(),
  routedComplaints: z.any().optional(),
  protocolVariance: z.any().optional(),
  diagnosticDrift: z.any().optional(),
  unifiedGovernance: z.any().optional(),
