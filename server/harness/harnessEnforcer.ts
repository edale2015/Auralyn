/**
 * harnessEnforcer.ts
 * server/harness/harnessEnforcer.ts
 *
 ...
 *
 * Wire into your existing agent loop:
 ...
 *   // Include ctx.promptBlock in your system/user message
 */
...
export async function buildClinicalContext(
  ...
  if (options.ehrPatientId) {
    try {
      ...
      // GP-05: EHR wins for medications and allergies
  ...
  // Self-report only when EHR data absent (GP-05)
  ...
  // Override patterns stub — TODO: query audit_hash_chain (90-day window)
