 ...
 * server/clinical/voice/complaintVoiceContexts.ts
 *
...
import type { QuestionContext } from "../../core/conversationNextBestQuestion";
...
export const CHEST_SOB_CONTEXTS: QuestionContext[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "jaw",      label: "Jaw",
        synonyms: ["jaw", "my jaw", "teeth", "chin", "face", "radiates to jaw"] },
...
// ═══════════════════════════════════════════════════════════════════════════════
// CLUSTER 4 — MUSCULOSKELETAL PAIN
// ═══════════════════════════════════════════════════════════════════════════════
  ...
  },
  {
    ...
    options: [
      ...
      { value: "minutes",  label: "Minutes",
        synonyms: ["minutes", "a few minutes", "couple minutes", "minute or two"] },
...
export const ABDOMINAL_CONTEXTS: QuestionContext[] = [
  {
    ...
    options: [
      ...
      { value: "luq",          label: "Left upper",
        synonyms: ["left side upper", "left upper", "under left ribs", "left upper quadrant"] },
      ...
      { value: "llq",          label: "Left lower",
        synonyms: ["left lower", "lower left", "left lower quadrant", "sigmoid area"] },
      ...
      { value: "periumbilical", label: "Around belly button",
        synonyms: ["belly button", "around belly button", "umbilical", "middle", "center"] },
      { value: "diffuse",      label: "All over",
        synonyms: ["everywhere", "all over", "whole belly", "cramping everywhere", "diffuse"] },
    ],
  },
  {
    ...
    options: [
      ...
      { value: "pressure",  label: "Pressure / Bloating",
        synonyms: ["pressure", "bloating", "bloated", "full feeling", "distended", "gassy"] },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "no",  label: "No", synonyms: ["no diarrhea", "normal", "no", "not loose"] },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { value: "gt_1_month", label: "More than a month ago",
        synonyms: ["over a month", "months ago", "long time ago", "more than a month"] },
    ],
  },
];
    ...
    options: [
      { value: "white_cottage", label: "White / Cottage cheese",
        synonyms: ["white", "chunky", "cottage cheese", "clumpy",
                   "thick white", "looks like cottage cheese", "yeast", "candida"] },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "no",  label: "No, bleeding stopped",
        synonyms: ["stopped", "not bleeding", "clotted", "stopped bleeding", "controlled"] },
    ],
  },
  {
    ...
    options: [
      ...
      { value: "5_10_years",  label: "5–10 years ago",
        synonyms: ["5 years ago", "10 years ago", "few years", "not sure but recently"] },
  ...
  },
  {
    ...
    options: [
      { value: "frontal",    label: "Forehead / Front",
        synonyms: ["forehead", "front", "behind eyes", "sinus area", "front of head"] },
      { value: "temporal",   label: "Temples / Sides",
        synonyms: ["temples", "sides", "temporal", "side of head", "my temples"] },
  ...
  },
  {
    ...
    options: [
      { value: "nausea",      label: "Nausea / Vomiting",
        synonyms: ["nausea", "nauseous", "vomiting", "sick to stomach", "throwing up"] },
  ...
  },
  {
    ...
    options: [
      { value: "fall",    label: "Fall",
        synonyms: ["fell", "fall", "tripped", "slipped", "fell down", "fell off"] },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "no",  label: "No — no pain",
        synonyms: ["no pain", "doesn't hurt", "just red", "painless", "not painful"] },
    ],
  },
  {
    ...
    options: [
      ...
      { value: "watery",   label: "Watery / Clear",
        synonyms: ["watery", "tearing", "clear", "tears", "watery discharge"] },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "hours",   label: "Hours",
        synonyms: ["hours", "long time", "all day", "persistent", "won't stop"] },
...
export const HTN_CONTEXTS: QuestionContext[] = [
  {
    ...
    options: [
      ...
      { value: "vision_changes", label: "Vision changes",
        synonyms: ["vision", "blurry", "can't see clearly", "spots", "vision is off"] },
  ...
  },
  {
    ...
    options: [
      { value: "yes", label: "Yes — took medications",
        synonyms: ["yes", "took it", "took them", "i took my meds", "took my pill"] },
