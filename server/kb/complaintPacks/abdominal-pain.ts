...
export function assessAbdominalPain(input: ValidationInput): TriageResult {
  return AbdominalPainPack.computeTriage(buildStateFromInput(input, "abdominal_pain", "abdominal pain"));
}
