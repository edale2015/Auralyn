...
export function synthesizePlan(input: ValidationInput): TriageResult {
  return URIRespiratoryPack.computeTriage(buildStateFromInput(input, "sore_throat", "URI symptoms"));
}
