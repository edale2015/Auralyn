...
//
// In server/gateway/llmGateway.ts, add at the top of complete():
//
//   import { localDevComplete } from "../dev/localDevHarness";
//
//   // Check local harness first (dev only — no-op in production)
...
//   }
//
//   // Continue with normal Anthropic/OpenAI routing...
