 ...
 *   2. Add <CDSSidebarPanel ... /> anywhere inside the outer <div> wrapper
 *      (the fixed button positions itself automatically)
 *
 * Example:
 *   <CDSSidebarPanel
 *     caseId={c.caseId}
...
export function CDSSidebarPanel({
  ...
  // Critical alert count for floating button badge
