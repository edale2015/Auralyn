 ...
 * Drop into: client/src/components/DashboardContextPrompt.tsx
 *
 ...
 *
 * Usage — add to the top of each dashboard page, before the data:
 *
 *   // Follow-up monitoring page:
 *   <DashboardContextPrompt
 *     context="followup"
 *     data={{ escalated: 3, active: 12, completed: 8 }}
 *   />
 *
 *   // Review queue page:
 *   <DashboardContextPrompt
 *     context="queue"
 *     data={{ urgent: 4, async: 11, total: 23 }}
 *   />
 *
 *   // Performance dashboard:
 *   <DashboardContextPrompt
 *     context="performance"
 *     data={{ grade: "B", overrideRate: 0.22, totalCases: 47 }}
 *   />
 *
 *   // Telemedicine dashboard:
 *   <DashboardContextPrompt
 *     context="telemed"
 *     data={{ active: 2, pendingDrafts: 2 }}
 *   />
 */
...
interface DashboardContextPromptProps {
  ...
  /** Override the auto-generated insight text */
  customInsight?: string;
  /** Override the auto-generated command */
...
// ─── Insight generators ───────────────────────────────────────────────────────
// Each context generates the most important insight from the current data.
// These surface what the physician actually needs to know, not everything.
...
export function DashboardContextPrompt({
  ...
  const openCommand = () => {
    // Dispatch a custom event that AuralynCommandInterface listens for
    // This pre-fills the command input and opens the interface
