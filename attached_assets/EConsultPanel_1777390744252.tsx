/**
 * EConsultPanel.tsx
 * Drop into: client/src/components/EConsultPanel.tsx
 *
 ...
 *
 * Usage in CaseReview.tsx (insert after line 245, closing </Card> of Case Summary):
 *
 ...
 *       patientMedications={c.answers?.structured?.medications ?? []}
 *       allergies={c.answers?.structured?.allergies ?? []}
 *     />
 *   )}
 */
...
export function EConsultPanel({
  ...
  // Auto-generate when panel is expanded for the first time
  const handleExpand = () => {
    setIsExpanded(true);
